...
<symbols>
<symbol name="AMC6821">
<pin name="VDD" x="-5.08" y="22.86" length="middle" direction="pwr" rot="R270"/>
<pin name="A0" x="2.54" y="22.86" length="middle" direction="in" rot="R270"/>
<pin name="A1" x="5.08" y="22.86" length="middle" direction="in" rot="R270"/>
<pin name="IN+" x="-15.24" y="-10.16" length="middle" direction="in"/>
<pin name="IN-" x="-15.24" y="-12.7" length="middle" direction="in"/>
<pin name="PWM-MODE" x="15.24" y="-15.24" length="middle" direction="in" rot="R180"/>
<pin name="SCLK" x="15.24" y="10.16" length="middle" direction="in" rot="R180"/>
<pin name="TACH" x="15.24" y="-10.16" length="middle" direction="in" rot="R180"/>
<pin name="GND" x="-5.08" y="-25.4" length="middle" direction="pas" rot="R90"/>
<pin name="~OVR" x="-15.24" y="5.08" length="middle" direction="out"/>
<pin name="~SMBALERT" x="15.24" y="0" length="middle" direction="out" rot="R180"/>
<pin name="PWM-OUT" x="15.24" y="-12.7" length="middle" direction="out" rot="R180"/>
<pin name="~FAN-FAULT" x="15.24" y="2.54" length="middle" direction="out" rot="R180"/>
<pin name="~THERM" x="-15.24" y="7.62" length="middle"/>
...
<text x="-7.6454" y="-5.08" size="2.0828" layer="95" ratio="10" rot="SR0">&gt;NAME</text>
<text x="-7.7216" y="-7.6962" size="2.0828" layer="96" ratio="10" rot="SR0">&gt;VALUE</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="AMC6821SDBQ" prefix="U">
<description>Intelligent Temperature Monitor and PWM Fan Controller</description>
<gates>
<gate name="A" symbol="AMC6821" x="0" y="0"/>
</gates>
<devices>
<device name="QSOP" package="QSOP-16N">
<connects>
<connect gate="A" pin="A0" pad="13"/>
<connect gate="A" pin="A1" pad="12"/>
<connect gate="A" pin="GND" pad="5"/>
<connect gate="A" pin="IN+" pad="10"/>
<connect gate="A" pin="IN-" pad="9"/>
<connect gate="A" pin="PWM-MODE" pad="11"/>
<connect gate="A" pin="PWM-OUT" pad="1"/>
<connect gate="A" pin="SCLK" pad="16"/>
<connect gate="A" pin="SDA" pad="15"/>
<connect gate="A" pin="TACH" pad="2"/>
<connect gate="A" pin="VDD" pad="6"/>
<connect gate="A" pin="~FAN-FAULT" pad="8"/>
<connect gate="A" pin="~OVR" pad="3"/>
<connect gate="A" pin="~SMBALERT" pad="14"/>
<connect gate="A" pin="~THERM" pad="7"/>
</connects>
<technologies>
<technology name="">
<attribute name="MPN" value="AMC6821SDBQ" constant="no"/>
<attribute name="OC_FARNELL" value="1754744" constant="no"/>
<attribute name="OC_NEWARK" value="52M3024" constant="no"/>
...
<wire x1="0.1778" y1="0" x2="0.1778" y2="-0.4318" width="0.2032" layer="21"/>
...
<package name="KSTG951AP">
<description>BUZZER, MAGNETIC, PIN, 85DB, 5V
&lt;br /&gt;
Element 14: 2215078</description>
<circle x="0" y="0" radius="1.016" width="0.1524" layer="21"/>
<circle x="0" y="0" radius="4.5" width="0.1524" layer="21"/>
<pad name="+" x="0" y="2" drill="0.9144" diameter="2.159" shape="octagon"/>
<pad name="-" x="0" y="-2" drill="0.9144" diameter="2.159" shape="octagon"/>
<text x="5.08" y="0.635" size="1.27" layer="25" ratio="10">&gt;NAME</text>
<text x="5.08" y="-1.2446" size="1.27" layer="27" ratio="10">&gt;VALUE</text>
<wire x1="-2.5" y1="2.5" x2="-2.5" y2="1.5" width="0.127" layer="22"/>
<wire x1="-3" y1="2" x2="-2" y2="2" width="0.127" layer="22"/>
<wire x1="-3" y1="-2" x2="-2" y2="-2" width="0.127" layer="22"/>
</package>
</packages>
<symbols>
...
<circle x="0" y="1.27" radius="1.36783125" width="0.254" layer="94"/>
</symbol>
<symbol name="GND">
<wire x1="-1.905" y1="0" x2="1.905" y2="0" width="0.254" layer="94"/>
<pin name="GND" x="0" y="2.54" visible="off" length="short" direction="sup" rot="R270"/>
<text x="-2.54" y="-5.08" size="1.778" layer="96">&gt;VALUE</text>
<wire x1="2.032" y1="0" x2="0" y2="-1.778" width="0.254" layer="94"/>
<wire x1="0" y1="-1.778" x2="-2.032" y2="0" width="0.254" layer="94"/>
</symbol>
<symbol name="M08">
...
<deviceset name="5V">
<description>5V SUPPLY</description>
<gates>
...
<gates>
<gate name="G$1" symbol="M02" x="5.08" y="12.7"/>
</gates>
<devices>
...
<description>&lt;b&gt;Molex 47053-1000&lt;/b&gt;&lt;p&gt;

&lt;i&gt;Alternatives:&lt;/i&gt;
&lt;ul&gt;
&lt;li&gt;Wieson 2366C888-007&lt;/li&gt;
...
<wire x1="5.08" y1="-3.175" x2="-5.08" y2="-3.175" width="0.254" layer="21"/>
<wire x1="-5.08" y1="-3.175" x2="-5.08" y2="3.175" width="0.254" layer="21"/>
<pad name="PWM" x="-3.81" y="0" drill="1" shape="long" rot="R90"/>
<pad name="SENSE" x="-1.27" y="0" drill="1" shape="long" rot="R90"/>
<pad name="VIN" x="1.27" y="0" drill="1" shape="long" rot="R90"/>
<pad name="VOUT" x="3.81" y="0" drill="1" shape="long" rot="R90"/>
...
<pad name="1-5V" x="-7.62" y="-6.35" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="2-GND" x="-2.54" y="-6.35" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="3-GND" x="2.54" y="-6.35" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="4-12V" x="7.62" y="-6.35" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
...
<pad name="1-5V" x="-7.62" y="0" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="2-GND" x="-2.54" y="0" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="3-GND" x="2.54" y="0" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<pad name="4-12V" x="7.62" y="0" drill="1.6" diameter="2.6" shape="long" rot="R90"/>
<text x="-12.7" y="-3.81" size="1.27" layer="25" rot="R90">&gt;NAME</text>
<text x="-7.62" y="5.08" size="1.27" layer="27">&gt;VALUE</text>
</package>
</packages>
<symbols>
<symbol name="FAN_4-WIRE">
<pin name="GND" x="0" y="-10.16" visible="pad" length="short" direction="out" rot="R90"/>
<pin name="PWR" x="0" y="10.16" visible="pad" length="short" direction="pwr" rot="R270"/>
<pin name="SENSE" x="-10.16" y="0" visible="pad" length="short"/>
<pin name="PWM" x="-10.16" y="-5.08" visible="pad" length="short" direction="in"/>
...
<wire x1="1.27" y1="-6.096" x2="-1.27" y2="-1.27" width="0.254" layer="94" curve="-180"/>
<wire x1="-1.27" y1="1.27" x2="-6.096" y2="-1.27" width="0.254" layer="94" curve="180"/>
<wire x1="-1.27" y1="6.096" x2="1.27" y2="1.27" width="0.254" layer="94" curve="-180"/>
<wire x1="1.27" y1="-1.27" x2="6.096" y2="1.27" width="0.254" layer="94" curve="180"/>
<wire x1="-6.858" y1="6.858" x2="-6.858" y2="-6.858" width="0.254" layer="94"/>
<wire x1="-6.858" y1="-6.858" x2="6.858" y2="-6.858" width="0.254" layer="94"/>
<wire x1="6.858" y1="-6.858" x2="6.858" y2="6.858" width="0.254" layer="94"/>
<wire x1="6.858" y1="6.858" x2="-6.858" y2="6.858" width="0.254" layer="94"/>
<circle x="0" y="0" radius="1.36783125" width="0.254" layer="94"/>
<wire x1="6.096" y1="1.27" x2="1.778" y2="0" width="0.254" layer="94" curve="-90"/>
<wire x1="-1.27" y1="6.096" x2="0" y2="1.778" width="0.254" layer="94" curve="-90"/>
<wire x1="-6.096" y1="-1.27" x2="-1.778" y2="0" width="0.254" layer="94" curve="-90"/>
<wire x1="1.27" y1="-6.096" x2="0" y2="-1.778" width="0.254" layer="94" curve="-90"/>
</symbol>
<symbol name="DISCDRIVE">
<description>MOLEX Power Connector</description>
...
<pin name="1-5V" x="-2.54" y="5.08" visible="pad" length="short" direction="pas" swaplevel="1"/>
<pin name="2-GND" x="-2.54" y="2.54" visible="pad" length="short" direction="pas" swaplevel="1"/>
<pin name="3-GND" x="-2.54" y="0" visible="pad" length="short" direction="pas" swaplevel="1"/>
<pin name="4-12V" x="-2.54" y="-2.54" visible="pad" length="short" direction="pas" swaplevel="1"/>
<circle x="2.54" y="5.08" radius="0.567959375" width="0.0635" layer="94"/>
<circle x="2.54" y="2.54" radius="0.567959375" width="0.0635" layer="94"/>
<circle x="2.54" y="0" radius="0.567959375" width="0.0635" layer="94"/>
<circle x="2.54" y="-2.54" radius="0.567959375" width="0.0635" layer="94"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="FAN_4-WIRE" prefix="X" uservalue="yes">
<description>&lt;b&gt;INTEL SPEC HEADER&lt;/b&gt;&lt;p&gt;
Source: http://www.molex.com/pdm_docs/sd/026604100_sd.pdf</description>
<gates>
<gate name="1" symbol="FAN_4-WIRE" x="-12.7" y="0"/>
</gates>
<devices>
<device name="INTEL" package="47053-1000">
<connects>
<connect gate="1" pin="GND" pad="VOUT"/>
<connect gate="1" pin="PWM" pad="PWM"/>
<connect gate="1" pin="PWR" pad="VIN"/>
<connect gate="1" pin="SENSE" pad="SENSE"/>
</connects>
<technologies>
<technology name=""/>
</technologies>
...
<deviceset name="DISCDRIVE" prefix="X">
...
<gates>
<gate name="G$1" symbol="DISCDRIVE" x="0" y="0" swaplevel="1"/>
</gates>
<devices>
<device name="R" package="9090-4R">
<connects>
<connect gate="G$1" pin="1-5V" pad="1-5V"/>
<connect gate="G$1" pin="2-GND" pad="2-GND"/>
<connect gate="G$1" pin="3-GND" pad="3-GND"/>
<connect gate="G$1" pin="4-12V" pad="4-12V"/>
</connects>
<technologies>
<technology name="">
<attribute name="MF" value="" constant="no"/>
...
<part name="U1" library="ti-fans" deviceset="AMC6821SDBQ" device="QSOP" value="AMC6821"/>
<part name="N1" library="arduino" deviceset="NMOSFET" device="GSD" value="NDS351AN"/>
<part name="F1" library="fans" deviceset="FAN_4-WIRE" device="INTEL"/>
<part name="C1" library="arduino" deviceset="CAP" device="0603" value="2200pF"/>
<part name="R1" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="U2" library="ti-fans" deviceset="AMC6821SDBQ" device="QSOP" value="AMC6821"/>
<part name="U3" library="ti-fans" deviceset="AMC6821SDBQ" device="QSOP" value="AMC6821"/>
<part name="U4" library="ti-fans" deviceset="AMC6821SDBQ" device="QSOP" value="AMC6821"/>
<part name="F2" library="fans" deviceset="FAN_4-WIRE" device="INTEL"/>
<part name="F3" library="fans" deviceset="FAN_4-WIRE" device="INTEL"/>
<part name="F4" library="fans" deviceset="FAN_4-WIRE" device="INTEL"/>
<part name="N2" library="arduino" deviceset="NMOSFET" device="GSD" value="NDS351AN"/>
<part name="N3" library="arduino" deviceset="NMOSFET" device="GSD" value="NDS351AN"/>
<part name="N4" library="arduino" deviceset="NMOSFET" device="GSD" value="NDS351AN"/>
<part name="C3" library="arduino" deviceset="CAP" device="0603" value="2200pF"/>
<part name="C4" library="arduino" deviceset="CAP" device="0603" value="2200pF"/>
<part name="C2" library="arduino" deviceset="CAP" device="0603" value="2200pF"/>
<part name="C5" library="arduino" deviceset="CAP" device="0603" value="100uF"/>
<part name="X1" library="fans" deviceset="DISCDRIVE" device="R"/>
<part name="GND1" library="arduino" deviceset="GND" device=""/>
<part name="H4" library="arduino" deviceset="M08" device=""/>
<part name="H3" library="arduino" deviceset="M08" device=""/>
<part name="H2" library="arduino" deviceset="M06" device="SIP"/>
<part name="H1" library="arduino" deviceset="M06" device="SIP"/>
<part name="RESET" library="arduino" deviceset="TAC_SWITCH" device="PTH"/>
<part name="GND3" library="arduino" deviceset="GND" device=""/>
<part name="M1" library="arduino" deviceset="PINHD-2X3" device=""/>
<part name="M2" library="arduino" deviceset="PINHD-2X3" device=""/>
<part name="M3" library="arduino" deviceset="PINHD-2X3" device=""/>
<part name="M4" library="arduino" deviceset="PINHD-2X3" device=""/>
<part name="IN1" library="arduino" deviceset="M02" device="PTH"/>
<part name="IN2" library="arduino" deviceset="M02" device="PTH"/>
<part name="IN3" library="arduino" deviceset="M02" device="PTH"/>
<part name="IN4" library="arduino" deviceset="M02" device="PTH"/>
<part name="GND4" library="arduino" deviceset="GND" device=""/>
<part name="GND5" library="arduino" deviceset="GND" device=""/>
<part name="GND6" library="arduino" deviceset="GND" device=""/>
<part name="GND7" library="arduino" deviceset="GND" device=""/>
<part name="R2" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R3" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R4" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R5" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R6" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R7" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R8" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="U$2" library="arduino" deviceset="5V" device=""/>
<part name="U$3" library="arduino" deviceset="5V" device=""/>
<part name="U$4" library="arduino" deviceset="5V" device=""/>
<part name="U$5" library="arduino" deviceset="5V" device=""/>
<part name="U$6" library="arduino" deviceset="5V" device=""/>
<part name="U$7" library="arduino" deviceset="5V" device=""/>
<part name="U$8" library="arduino" deviceset="5V" device=""/>
<part name="U$9" library="arduino" deviceset="5V" device=""/>
<part name="U$10" library="arduino" deviceset="5V" device=""/>
<part name="GND8" library="arduino" deviceset="GND" device=""/>
<part name="R9" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R10" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="GND9" library="arduino" deviceset="GND" device=""/>
<part name="R11" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R12" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R13" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R14" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R15" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R16" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R17" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R18" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R19" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="R20" library="arduino" deviceset="RESISTOR" device="0603" value="4K7"/>
<part name="U$11" library="arduino" deviceset="5V" device=""/>
<part name="GND2" library="arduino" deviceset="GND" device=""/>
<part name="PWR" library="arduino" deviceset="LED" device="0603" value="BLUE"/>
<part name="FAULT" library="arduino" deviceset="LED" device="0603" value="RED"/>
<part name="SP1" library="arduino" deviceset="BUZZER" device=""/>
<part name="GND10" library="arduino" deviceset="GND" device=""/>
<part name="R21" library="arduino" deviceset="RESISTOR" device="0603" value="1K"/>
<part name="U$1" library="arduino" deviceset="5V" device=""/>
<part name="GND11" library="arduino" deviceset="GND" device=""/>
<part name="R22" library="arduino" deviceset="RESISTOR" device="0603" value="1K"/>
</parts>
<sheets>
<sheet>
<plain>
<text x="247.65" y="5.334" size="1.778" layer="94">V1.0</text>
<text x="252.476" y="26.924" size="1.778" layer="94" rot="R90">(C) 2013 Tecsmith</text>
<text x="255.27" y="26.924" size="1.778" layer="94" rot="R90">Released under the TAPR Open Hardware License: www.tapr.org/ohl</text>
<text x="216.916" y="20.828" size="1.778" layer="94">www.tecsmith.com.au</text>
<wire x1="17.78" y1="149.86" x2="22.86" y2="149.86" width="0.1524" layer="93"/>
<wire x1="22.86" y1="149.86" x2="22.86" y2="147.32" width="0.1524" layer="93"/>
<wire x1="22.86" y1="147.32" x2="35.56" y2="147.32" width="0.1524" layer="93"/>
<wire x1="17.78" y1="147.32" x2="20.32" y2="147.32" width="0.1524" layer="93"/>
<wire x1="20.32" y1="147.32" x2="20.32" y2="142.24" width="0.1524" layer="93"/>
<wire x1="20.32" y1="142.24" x2="35.56" y2="142.24" width="0.1524" layer="93"/>
</plain>
<instances>
<instance part="FRAME1" gate="G$1" x="0" y="0"/>
<instance part="U1" gate="A" x="40.64" y="114.3"/>
<instance part="N1" gate="G$1" x="20.32" y="38.1"/>
<instance part="F1" gate="1" x="63.5" y="63.5"/>
<instance part="C1" gate="G$1" x="22.86" y="83.82" rot="R90"/>
<instance part="R1" gate="G$1" x="68.58" y="99.06" rot="R90"/>
<instance part="U2" gate="A" x="99.06" y="114.3"/>
<instance part="U3" gate="A" x="157.48" y="114.3"/>
<instance part="U4" gate="A" x="215.9" y="114.3"/>
<instance part="F2" gate="1" x="121.92" y="63.5"/>
<instance part="F3" gate="1" x="180.34" y="63.5"/>
<instance part="F4" gate="1" x="238.76" y="63.5"/>
<instance part="N2" gate="G$1" x="78.74" y="38.1"/>
<instance part="N3" gate="G$1" x="137.16" y="38.1"/>
<instance part="N4" gate="G$1" x="195.58" y="38.1"/>
<instance part="C3" gate="G$1" x="139.7" y="83.82" rot="R90"/>
<instance part="C4" gate="G$1" x="198.12" y="83.82" rot="R90"/>
<instance part="C2" gate="G$1" x="81.28" y="83.82" rot="R90"/>
<instance part="C5" gate="G$1" x="78.74" y="154.94"/>
<instance part="X1" gate="G$1" x="20.32" y="157.48"/>
<instance part="GND1" gate="1" x="205.74" y="157.48"/>
<instance part="H4" gate="G$1" x="66.04" y="167.64" rot="R270"/>
<instance part="H3" gate="G$1" x="121.92" y="167.64" rot="R270"/>
<instance part="H2" gate="G$1" x="177.8" y="167.64" rot="R270"/>
<instance part="H1" gate="G$1" x="231.14" y="167.64" rot="R270"/>
<instance part="RESET" gate="S" x="215.9" y="162.56"/>
<instance part="GND3" gate="1" x="154.94" y="25.4"/>
<instance part="M1" gate="A" x="55.88" y="38.1"/>
<instance part="M2" gate="A" x="114.3" y="38.1"/>
<instance part="M3" gate="A" x="172.72" y="38.1"/>
<instance part="M4" gate="A" x="231.14" y="38.1"/>
<instance part="IN1" gate="G$1" x="25.4" y="66.04" rot="R90"/>
<instance part="IN2" gate="G$1" x="83.82" y="66.04" rot="R90"/>
<instance part="IN3" gate="G$1" x="142.24" y="66.04" rot="R90"/>
<instance part="IN4" gate="G$1" x="200.66" y="66.04" rot="R90"/>
<instance part="GND4" gate="1" x="35.56" y="86.36"/>
<instance part="GND5" gate="1" x="93.98" y="86.36"/>
<instance part="GND6" gate="1" x="152.4" y="86.36"/>
<instance part="GND7" gate="1" x="210.82" y="86.36"/>
<instance part="R2" gate="G$1" x="68.58" y="86.36" rot="R90"/>
<instance part="R3" gate="G$1" x="127" y="99.06" rot="R90"/>
<instance part="R4" gate="G$1" x="127" y="86.36" rot="R90"/>
<instance part="R5" gate="G$1" x="185.42" y="99.06" rot="R90"/>
<instance part="R6" gate="G$1" x="185.42" y="86.36" rot="R90"/>
<instance part="R7" gate="G$1" x="243.84" y="99.06" rot="R90"/>
<instance part="R8" gate="G$1" x="243.84" y="86.36" rot="R90"/>
<instance part="U$2" gate="G$1" x="71.12" y="93.98" rot="R270"/>
<instance part="U$3" gate="G$1" x="129.54" y="93.98" rot="R270"/>
<instance part="U$4" gate="G$1" x="187.96" y="93.98" rot="R270"/>
<instance part="U$5" gate="G$1" x="246.38" y="93.98" rot="R270"/>
<instance part="U$6" gate="G$1" x="35.56" y="144.78"/>
<instance part="U$7" gate="G$1" x="93.98" y="144.78"/>
<instance part="U$8" gate="G$1" x="152.4" y="144.78"/>
<instance part="U$9" gate="G$1" x="210.82" y="144.78"/>
<instance part="U$10" gate="G$1" x="228.6" y="147.32" rot="R90"/>
<instance part="GND8" gate="1" x="236.22" y="154.94"/>
<instance part="R9" gate="G$1" x="10.16" y="15.24" rot="R90"/>
<instance part="R10" gate="G$1" x="25.4" y="15.24" rot="R90"/>
<instance part="GND9" gate="1" x="76.2" y="149.86"/>
<instance part="R11" gate="G$1" x="43.18" y="15.24" rot="R90"/>
...
<instance part="R15" gate="G$1" x="86.36" y="15.24" rot="R90"/>
<instance part="R16" gate="G$1" x="99.06" y="15.24" rot="R90"/>
<instance part="R17" gate="G$1" x="109.22" y="15.24" rot="R90"/>
<instance part="R18" gate="G$1" x="119.38" y="15.24" rot="R90"/>
<instance part="R19" gate="G$1" x="132.08" y="15.24" rot="R90"/>
<instance part="R20" gate="G$1" x="147.32" y="15.24" rot="R90"/>
<instance part="U$11" gate="G$1" x="7.62" y="27.94"/>
<instance part="GND2" gate="1" x="7.62" y="157.48"/>
<instance part="PWR" gate="G$1" x="172.72" y="20.32" rot="R270"/>
<instance part="FAULT" gate="G$1" x="195.58" y="20.32" rot="R270"/>
<instance part="SP1" gate="1" x="149.86" y="165.1" rot="R270"/>
<instance part="GND10" gate="1" x="149.86" y="154.94"/>
<instance part="R21" gate="G$1" x="167.64" y="10.16" rot="R90"/>
<instance part="U$1" gate="G$1" x="180.34" y="20.32" rot="R270"/>
<instance part="GND11" gate="1" x="210.82" y="10.16"/>
<instance part="R22" gate="G$1" x="190.5" y="10.16" rot="R90"/>
</instances>
<busses>
</busses>
<nets>
...
<pinref part="U1" gate="A" pin="PWM-MODE"/>
...
<pinref part="U2" gate="A" pin="PWM-MODE"/>
...
<pinref part="U3" gate="A" pin="PWM-MODE"/>
...
<pinref part="U4" gate="A" pin="PWM-MODE"/>
...
<wire x1="231.14" y1="162.56" x2="231.14" y2="147.32" width="0.1524" layer="91"/>
</segment>
<segment>
...
<wire x1="243.84" y1="30.48" x2="198.12" y2="30.48" width="0.1524" layer="91"/>
...
<wire x1="124.46" y1="48.26" x2="81.28" y2="48.26" width="0.1524" layer="91"/>
<pinref part="N2" gate="G$1" pin="D"/>
...
<wire x1="241.3" y1="48.26" x2="198.12" y2="48.26" width="0.1524" layer="91"/>
<pinref part="N4" gate="G$1" pin="D"/>
...
<pinref part="U2" gate="A" pin="PWM-OUT"/>
...
<wire x1="101.6" y1="81.28" x2="101.6" y2="38.1" width="0.1524" layer="91"/>
...
<segment>
<pinref part="U1" gate="A" pin="PWM-OUT"/>
...
<wire x1="43.18" y1="81.28" x2="43.18" y2="38.1" width="0.1524" layer="91"/>
...
<segment>
<pinref part="U3" gate="A" pin="PWM-OUT"/>
...
<segment>
<pinref part="U4" gate="A" pin="PWM-OUT"/>
...
<wire x1="218.44" y1="81.28" x2="218.44" y2="38.1" width="0.1524" layer="91"/>
...
<segment>
<wire x1="10.16" y1="76.2" x2="63.5" y2="76.2" width="0.1524" layer="91"/>
<pinref part="F4" gate="1" pin="PWR"/>
<wire x1="63.5" y1="76.2" x2="121.92" y2="76.2" width="0.1524" layer="91"/>
<wire x1="121.92" y1="76.2" x2="180.34" y2="76.2" width="0.1524" layer="91"/>
...
<pinref part="X1" gate="G$1" pin="4-12V"/>
<wire x1="17.78" y1="154.94" x2="10.16" y2="154.94" width="0.1524" layer="91"/>
<wire x1="10.16" y1="154.94" x2="10.16" y2="76.2" width="0.1524" layer="91"/>
<label x="10.16" y="147.32" size="1.778" layer="95" xref="yes"/>
</segment>
</net>
<net name="N$17" class="0">
<segment>
<pinref part="U4" gate="A" pin="TACH"/>
<wire x1="231.14" y1="104.14" x2="238.76" y2="104.14" width="0.1524" layer="91"/>
<wire x1="238.76" y1="104.14" x2="238.76" y2="78.74" width="0.1524" layer="91"/>
...
<pinref part="F4" gate="1" pin="SENSE"/>
...
<segment>
<pinref part="U3" gate="A" pin="TACH"/>
...
<pinref part="F3" gate="1" pin="SENSE"/>
...
<segment>
<pinref part="U2" gate="A" pin="TACH"/>
...
<pinref part="F2" gate="1" pin="SENSE"/>
...
<segment>
<pinref part="U1" gate="A" pin="TACH"/>
...
<pinref part="F1" gate="1" pin="SENSE"/>
...
<wire x1="200.66" y1="101.6" x2="200.66" y2="83.82" width="0.1524" layer="91"/>
...
<wire x1="193.04" y1="104.14" x2="193.04" y2="83.82" width="0.1524" layer="91"/>
...
<segment>
<pinref part="X1" gate="G$1" pin="1-5V"/>
...
<wire x1="177.8" y1="162.56" x2="177.8" y2="149.86" width="0.1524" layer="91"/>
...
<label x="182.88" y="154.94" size="1.778" layer="95" xref="yes"/>
</segment>
</net>
...
<label x="116.84" y="154.94" size="1.778" layer="95" rot="R180" xref="yes"/>
</segment>
</net>
...
<wire x1="124.46" y1="144.78" x2="124.46" y2="162.56" width="0.1524" layer="91"/>
...
<label x="132.08" y="160.02" size="1.778" layer="95" xref="yes"/>
</segment>
<segment>
...
<wire x1="71.12" y1="162.56" x2="71.12" y2="134.62" width="0.1524" layer="91"/>
...
<label x="195.58" y="129.54" size="1.778" layer="95" rot="R90" xref="yes"/>
</segment>
<segment>
...
<wire x1="66.04" y1="162.56" x2="66.04" y2="144.78" width="0.1524" layer="91"/>
...
<label x="200.66" y="129.54" size="1.778" layer="95" rot="R90" xref="yes"/>
</segment>
<segment>
...
<segment>
<pinref part="U3" gate="A" pin="~THERM"/>
<wire x1="142.24" y1="121.92" x2="142.24" y2="129.54" width="0.1524" layer="91"/>
<label x="142.24" y="129.54" size="1.778" layer="95" rot="R90" xref="yes"/>
</segment>
<segment>
...
<label x="58.42" y="160.02" size="1.778" layer="95" rot="R180" xref="yes"/>
</segment>
<segment>
<pinref part="U2" gate="A" pin="~OVR"/>
...
<label x="78.74" y="129.54" size="1.778" layer="95" rot="R90" xref="yes"/>
</segment>
<segment>
...
<wire x1="121.92" y1="144.78" x2="121.92" y2="162.56" width="0.1524" layer="91"/>
...
<segment>
<pinref part="U2" gate="A" pin="~SMBALERT"/>
...
<segment>
<pinref part="U3" gate="A" pin="~SMBALERT"/>
...
<segment>
<pinref part="U4" gate="A" pin="~SMBALERT"/>
...
<wire x1="106.68" y1="45.72" x2="73.66" y2="45.72" width="0.1524" layer="91"/>
<pinref part="N2" gate="G$1" pin="G"/>
...
<wire x1="223.52" y1="45.72" x2="190.5" y2="45.72" width="0.1524" layer="91"/>
<pinref part="N4" gate="G$1" pin="G"/>
...
<label x="137.16" y="129.54" size="1.778" layer="95" rot="R90" xref="yes"/>
</segment>
<segment>
...
<errors>
<approved hash="104,1,35.56,137.16,U1,VDD,5V,,,"/>
<approved hash="202,1,45.72,137.16,U1,A1,,,,"/>
<approved hash="104,1,63.5,73.66,F1,PWR,12V,,,"/>
<approved hash="104,1,93.98,137.16,U2,VDD,5V,,,"/>
<approved hash="202,1,101.6,137.16,U2,A0,,,,"/>
<approved hash="202,1,104.14,137.16,U2,A1,,,,"/>
<approved hash="104,1,152.4,137.16,U3,VDD,5V,,,"/>
<approved hash="104,1,210.82,137.16,U4,VDD,5V,,,"/>
<approved hash="202,1,218.44,137.16,U4,A0,,,,"/>
<approved hash="104,1,121.92,73.66,F2,PWR,12V,,,"/>
<approved hash="104,1,180.34,73.66,F3,PWR,12V,,,"/>
<approved hash="104,1,238.76,73.66,F4,PWR,12V,,,"/>
<approved hash="106,1,228.6,162.56,3V3,,,,,"/>
<approved hash="106,1,172.72,162.56,A0,,,,,"/>
<approved hash="106,1,175.26,162.56,A1,,,,,"/>
<approved hash="106,1,177.8,162.56,A2,,,,,"/>
<approved hash="106,1,180.34,162.56,A3,,,,,"/>
<approved hash="106,1,114.3,162.56,D0-RX,,,,,"/>
<approved hash="106,1,116.84,162.56,D1-TX,,,,,"/>
<approved hash="206,1,55.88,116.84,D2-INT0,,,,,"/>
<approved hash="206,1,114.3,116.84,D2-INT0,,,,,"/>
<approved hash="206,1,172.72,116.84,D2-INT0,,,,,"/>
<approved hash="206,1,231.14,116.84,D2-INT0,,,,,"/>
<approved hash="206,1,55.88,114.3,~D3-INT1,,,,,"/>
<approved hash="206,1,114.3,114.3,~D3-INT1,,,,,"/>
<approved hash="206,1,172.72,114.3,~D3-INT1,,,,,"/>
<approved hash="206,1,231.14,114.3,~D3-INT1,,,,,"/>
<approved hash="111,1,231.14,121.92,A4-SDA,,,,,"/>
<approved hash="115,1,130.071,89.431,FRAME1,,,,,"/>
<approved hash="115,1,59.6904,63.5,F1,,,,,"/>
<approved hash="115,1,118.11,63.5,F2,,,,,"/>
<approved hash="115,1,176.53,63.5,F3,,,,,"/>
<approved hash="115,1,234.95,63.5,F4,,,,,"/>
<approved hash="115,1,68.7747,165.777,H4,,,,,"/>
<approved hash="115,1,124.655,165.777,H3,,,,,"/>
<approved hash="115,1,180.535,165.777,H2,,,,,"/>
<approved hash="115,1,233.875,165.777,H1,,,,,"/>
<approved hash="115,1,215.9,164.711,RESET,,,,,"/>
<approved hash="115,1,57.1077,39.5012,M1,,,,,"/>
<approved hash="115,1,115.528,39.5012,M2,,,,,"/>
<approved hash="115,1,173.948,39.5012,M3,,,,,"/>
<approved hash="115,1,232.368,39.5012,M4,,,,,"/>
</errors>
</schematic>
</drawing>
</eagle>
